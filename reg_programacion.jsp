...
<script>
        ...
        window.onload = function() {
            mostrarPopup();
            window.location.href = "./Curso Programacion.html";
        };
</script>
</head>
<body>
<%
    ...
    String sql = "INSERT INTO matricula (cedula, id_curso, nombre_usuario, fecha_inic) VALUES ('" + cedula + "', 'Programacion', '" + nombre + "', '" + fechaInicio + "')";
